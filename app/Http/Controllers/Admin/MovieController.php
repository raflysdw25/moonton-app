...
class MovieController extends Controller
{
    ...
    {
        // withTrashed: Untuk mengambil data yang sudah di softDelete (deleted_at nya sudah diisi)
    ...
    public function store(Store $request)
    {
        ...
        // Method with digunakan untuk mengirimkan data untuk flash message (pesan popup)
        // Perlu inisialisasi di HandleInertiaRequests (flashMessage)
